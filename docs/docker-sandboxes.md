...
cd ~
git clone https://github.com/ambroseacoulter/nanoclaw-oi.git
...
```bash
cd ~ && git clone https://github.com/ambroseacoulter/nanoclaw-oi.git && mv nanoclaw-oi /path/to/workspace/nanoclaw-oi
```
