...
Add Parallel AI usage instructions to the agent workspace `CLAUDE.md` files that should have web-research access. Start with the owner's admin workspace, typically `groups/main/CLAUDE.md` on migrated installs.
...
> Send a message to your assistant from an admin or adult agent that is allowed to use Parallel: `@[YourAssistantName] what's the latest news about AI?`
>
...
3. Remove Web Research Tools section from the affected agent workspace `CLAUDE.md`
